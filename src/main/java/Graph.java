public class Graph {
    ...
    public boolean hasPath(int vertex1, int vertex2, boolean[] visited) {
        // FILL IN CODE: use DFS to find out if there is path from vertex 1 to vertex 2

        // A good idea to then implement it with BFS to get practice (queue code provided)
        return false;
    }
